...
const leaderboardData = [
  ...
  },
  {
    id: 2,
    name: 'Test User',
    avatar: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAALIAAACUCAMAAAAAoYNxAAAAA1BMVEUAAACnej3aAAAAMUlEQVR4nO3BAQ0AAADCoPdPbQ43oAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAADgywBnfAABIm7MIAAAAABJRU5ErkJggg==',
    points: 5,
    badges: ['Tester'],
    activities: {
      adventure: 0,
